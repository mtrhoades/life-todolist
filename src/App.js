    ...
    <div className="App">
      ...
      <div className="section">
        ...
        <ul>
          ...
          <li>Fix leaning bookshelf in bedroom</li>
          <li>Setup cameras around house and backyard</li>
          <li>Get security door for garage side door</li>
          <li>Get mesh screen for dryer vent outside</li>
      ...
      <div className="section">
        ...
        <ul>
          ...
          <li>Setup home lab - server, etc.</li>
          <li>Create a tax schedule for paying taxes throughout the year - get G.E. License?!</li>
        </ul>
      </div>
